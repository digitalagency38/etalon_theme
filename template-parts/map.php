<section class="map">
	<div class="container">
		<div class="map-wrapper">
			...
			<div class="map-wrapper__contacts">
				<h3>Контакты</h3>

				<address><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-place.svg" alt="">
					г.Иркутск ул. Партизанская, 63
				</address>
				<div class="phone"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/icon-phone.svg"
										alt=""><a href="tel:+73952707131">+7 (3952) 707-131</a></div>
