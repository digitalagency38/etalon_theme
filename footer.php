...
<div class="modal fade form_sending" id="feedback" tabindex="-1"
     aria-labelledby="remoteSearchLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header"
...
<script>
    jQuery(function() {
        ...
        document.addEventListener( 'wpcf7mailsent', function( event ) {
            ...
            event.target.closest('.modal-content').classList.add('isSent');
            }
            if (event.target.closest('.formBlock')) {
            event.target.closest('.formBlock').classList.add('isSent');
            }
            if (event.target.closest('.form_sending')) {
            event.target.closest('.form_sending').classList.add('isSent');
            }
        }, false );
    })
</script>
