...
<div class="container">
	...
	<div class="form_promo__title">Заявка на подбор мебели</div>
	<div class="form_promo__text">Также как консультация с широким активом влечет за собой процесс внедрения и модернизации вывода текущих активов.</div>
		<?php echo do_shortcode('[contact-form-7 id="13456" title="Заявка на подбор мебели"]')?>
	</div>
</div>
...
?>
    ...
    ?>
				...
				<div class="products__list__more">Смотреть всё</div>
            </main>
        </div>
...
const items = document.querySelectorAll('.tax_product--js');
